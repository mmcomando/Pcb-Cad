...
final class Something : Drawable {
	...
	static Something fromPoints(T)(in T[] points) {
		GpuMemory m = gameEngine.renderer.verticesAllocator.allocate(points.length * T.sizeof);
		m.write(points);
...
Something toDrawable(AnyShape shape){
	Triangle[] triangles=shape.getTriangles();
	auto somethingDrawable = Something.fromPoints(triangles);
	somethingDrawable.mode = GL_TRIANGLES;
	return somethingDrawable;
}
...
/*
 ...
 inTri = true 
 inTri = inTri and pointInTriangle(t1.p1,t1.p2,t1.p3, t2.p1)
 inTri = inTri and pointInTriangle(t1.p1,t1.p2,t1.p3, t2.p2)
 inTri = inTri and pointInTriangle(t1.p1,t1.p2,t1.p3, t2.p3)
 if inTri == true: return true
 inTri = true
 inTri = inTri and pointInTriangle(t2.p1,t2.p2,t2.p3, t1.p1)
 inTri = inTri and pointInTriangle(t2.p1,t2.p2,t2.p3, t1.p2)
 inTri = inTri and pointInTriangle(t2.p1,t2.p2,t2.p3, t1.p3)
 if inTri == true: return true
 return False*/